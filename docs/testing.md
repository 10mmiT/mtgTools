...
The project ships a test suite using Node's built-in `node:test` runner and `supertest` — over 1,200 tests across 51 files, needing no browser and no network.
